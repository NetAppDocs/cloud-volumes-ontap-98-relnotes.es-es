...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-aws-c2s.html#limitations["Vea las limitaciones de Cloud Volumes ONTAP en AWS C2S"^].
